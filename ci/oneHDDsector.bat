...
IF "%1"=="-r" (
	...
	"C:\Program Files\sigrok\sigrok-cli\sigrok-cli" -D -i ..\test\MFM_HDDdataOneSector.sr -P mfm:dsply_pfx=yes:dsply_sn=yes | "C:\Program Files\7-Zip\7z" u -siMFM_HDDdataOneSector MFM_HDDdataOneSector.7z

    ECHO Ggenerating reference MFM_HDDdataOneSector.crc
